...
public class NerApiHandler {
    ...
    private NerApiHandler(Context context) throws NoSuchAlgorithmException, KeyStoreException {
        ...
        okHBuilder.connectTimeout(CONNECT_TIMEOUT, TimeUnit.SECONDS)
                .sslSocketFactory(SSL.getSSLSocketFactory(context), trustManager)
    ...
    public static NerApiHandler getInstance(Context context) throws KeyStoreException, NoSuchAlgorithmException {
        if(INSTANCE == null) {
